...
**
** Created: Fri 2. Jun 09:55:02 2017
...
const QMetaObject FormSelectElements::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FormSelectElements,
      qt_meta_data_FormSelectElements, 0 }
};
...
int FormSelectElements::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: editFields(); break;
        case 1: closeEvent((*reinterpret_cast< QCloseEvent*(*)>(_a[1]))); break;
        case 2: slotClik((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 3: slotAdd(); break;
        case 4: slotDel(); break;
        case 5: nextClk(); break;
        case 6: cancelClk(); break;
        default: ;
        }
        _id -= 7;
    }
